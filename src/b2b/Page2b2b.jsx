      ...
      <form onSubmit={handleSubmit(onSubmit)}>
        <Grid container spacing={1} columnSpacing={8}>
          ...
          <Grid item container xs={12} md={5}>
            ...
            >
             <OptionButton  onClick={() => (nextStepObj.isOptional = true)} type="submit">{option}</OptionButton>
              <PaymentButton onClick={() => (nextStepObj.isOptional = false)} type="submit">{ekdosi}</PaymentButton>
